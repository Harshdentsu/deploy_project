...
const ChatMessages = ({
  ...
  return (
    <ScrollArea className="flex-1 px-2 sm:px-4 md:px-6 py-4 md:pr-2">
      <div className="w-full max-w-3xl mx-auto space-y-6">
        ...
        {messages.map((message, index) => (
          ...
          >
            <div
              className={`flex w-full max-w-4xl ${message.sender === "user"
                ? "flex-row-reverse items-center gap-1 sm:gap-4"
            ...
            >
              ...
              {/* Message Bubble */}
              <div
                className={`rounded-2xl p-3 sm:p-4 text-sm sm:text-base max-w-[90vw] md:max-w-[75%] lg:max-w-[70%] xl:max-w-[60%] break-words ${message.sender === "user"
                  ? "bg-gray-100 dark:bg-[#1A1A1F] text-gray-900 dark:text-white text-right ml-2"
                  : "bg-white dark:bg-[#1A1A1F] text-gray-900 dark:text-white border border-gray-200 dark:border-[#3B3B45] text-left mr-2"
                  }`}
              >
                <ReactMarkdown
                  components={{
