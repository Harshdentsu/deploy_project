...
- Dealers can access:
  ...
  * sales data → Filter sales queries with: AND s.dealer_id = {current_user.dealer_id}
  *claims data → Filter claims queries with: AND c.dealer_id = {current_user.dealer_id}
...
"""
    ...
    system_prompt = (
        ...
        "3. claim(claim_id, dealer_id, status,claim_date,resolved_date,product_id,amount,approved_amount,reason): Stores warranty or service claims made by dealers.\n"
